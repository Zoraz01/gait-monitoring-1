...
//Need to change this to what the UID of our device is
const val CCCD_DESCRIPTOR_UUID = "0000180F-0000-1000-8000-00805F9B34FB"

/**
 * Utility function used to get GATT table so one can troubleshoot BLE connections
 */
